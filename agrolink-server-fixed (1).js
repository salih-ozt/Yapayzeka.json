...
app.get('/api/farmbook/records', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
...
// Farmbook kaydı ekle
app.post('/api/farmbook/records', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
        const {
...
app.put('/api/farmbook/records/:id', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
        const { id } = req.params;
...
app.delete('/api/farmbook/records/:id', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
        const { id } = req.params;
...
app.get('/api/farmbook/stats', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
...
app.get('/api/farmbook/export', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
...
app.get('/api/farmbook/fields', authenticate, async (req, res) => {
    try {
        const userId = req.user.id;
